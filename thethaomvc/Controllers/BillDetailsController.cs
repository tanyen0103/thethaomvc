...
namespace thethaomvc.Controllers
{
    public class BillDetailsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.BillDetail.Include(b => b.Bill).Include(b => b.SanPham);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.SanPham, "IdSP", "TenSP");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("BillDetailId,BillId,Price,Quantity,Amount,SanPhamIdSP")] BillDetail billDetail)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.SanPham, "IdSP", "TenSP", billDetail.ProductId);
            return View(billDetail);
        }
